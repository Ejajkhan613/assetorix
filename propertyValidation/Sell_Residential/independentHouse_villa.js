...
function independentHouse_villa(data) {
    ...
    if (data.propertyFeatures) {
        const list = ["High Ceiling Height", "False Ceiling Lighting", "Piped-gas", "Internet / wi-fi connectivity", "Centrally Air Renovated", "Water Purifier", "Recently Renovated", "Natural Light", "Airy Roooms", "Spacious Interiors"];
