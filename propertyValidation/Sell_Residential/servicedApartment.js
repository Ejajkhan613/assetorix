...
function servicedApartment(data) {
    ...
    // Amenities ( Optional )
    if (data.amenities) {
        const list = ["Maintenance Staff", "Water Storage", "Security / Fire Alarm", "Rain Water Harvesting", "Visitor Parking", "Park", "Feng Shui / Vaastu Compliant", "Lift"];
...
// Exporting Module
module.exports = { servicedApartment };
