...
function factory(data) {
    ...
    // Industry Type
    let industryType = component.industryType(data.industryType);
    if (industryType.msg == "SUCCESS") {
        obj.industryType = industryType.data;
    } else {
        return industryType;
    }
...
//     }
//     // Adding Office Type
//     obj.industryType = xss(data.industryType);
