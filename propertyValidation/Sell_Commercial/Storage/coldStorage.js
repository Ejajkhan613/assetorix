...
function coldStorage(data) {
    ...
    // Storage Type
    let storageType = component.storageType(data.storageType);
    if (storageType.msg == "SUCCESS") {
        obj.storageType = storageType.data;
    } else {
        return storageType;
    }
    ...
    // Address ( Optional )
    let addressValue = component.houseNumber(data.address.address);
    if (addressValue.msg == "SUCCESS") {
        address.address = addressValue.data;
    } else {
        return addressValue;
    }
