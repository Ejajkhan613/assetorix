...
function commercial_InstitutionalLand(data) {
    ...
    let approvedIndustryTypeList = component.approvedIndustryTypeList(data.approvedIndustryTypeList);
    if (approvedIndustryTypeList.msg == "SUCCESS") {
        obj.approvedIndustryTypeList = approvedIndustryTypeList.data;
    } else {
        return approvedIndustryTypeList;
    }
...
// Exporting Module
module.exports = { commercial_InstitutionalLand };
...
//     // Adding List of Approved Industry Type List
//     if (data.approvedIndustryTypeList) {

//         let approvedIndustryTypeList = [];

//         for (let a = 0; a < data.approvedIndustryTypeList.length; a++) {
//             approvedIndustryTypeList.push(xss(data.approvedIndustryTypeList[a]));
//         }
//         obj.approvedIndustryTypeList = approvedIndustryTypeList;
//     }
